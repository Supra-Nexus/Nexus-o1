#!/usr/bin/env python3
"""Upload Supra Nexus O1 training datasets to HuggingFace"""
...
def main():
    ...
    repo_id = "Supra-Nexus/supra-nexus-o1-training"
    ...
    for directory in [training_dir, data_dir]:
        if directory.exists():
            files_to_upload.extend(directory.glob("*.jsonl"))
    ...
    readme_path.write_text(create_dataset_card())
