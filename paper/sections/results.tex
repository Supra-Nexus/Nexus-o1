...
\midrule
Qwen3-2B-Instruct & 18.4 & 62.1 & 18.4 & 2.1/5.0 \\
...
\midrule
\textbf{\supra{} (4B)} & \textbf{42.7} & \textbf{86.3} & \textbf{42.7} & \textbf{4.3/5.0} \\
\textbf{\zennano{} (4B)} & 28.1 & 74.6 & 28.1 & 3.1/5.0 \\
\bottomrule
\end{tabular}
...
Key findings:
\begin{itemize}
    \item \supra{} achieves 132\% relative improvement over base model (+24.3 absolute points)
    \item Step accuracy improvement of +24.2 points demonstrates better reasoning process
    \item Reasoning quality rated by human evaluators shows 105\% improvement
    \item Performance approaches GPT-3.5-Turbo despite being 8× smaller
\end{itemize}
...
\midrule
Qwen3-2B-Instruct & 12.2 & 23.8 & 4.2 & 78.4 & 45.1 \\
...
\midrule
\textbf{\supra{} (4B)} & \textbf{27.4} & \textbf{52.1} & \textbf{2.9} & \textbf{89.6} & \textbf{68.3} \\
\textbf{\zennano{} (4B)} & 18.9 & 36.2 & 3.4 & 84.1 & 57.8 \\
\bottomrule
\end{tabular}
...
Supra-4B-Instruct & 48.3 & 74.1 & 23.7 & 16.8 & 46.2 & 42.1 \\
\textbf{\supra{}-Thinking} & \textbf{56.0} & \textbf{79.8} & \textbf{42.7} & \textbf{27.4} & \textbf{54.3} & \textbf{51.2} \\
\midrule
Zen-4B-Instruct & 46.9 & 72.8 & 21.2 & 14.5 & 44.1 & 40.3 \\
\textbf{\zennano{}-Thinking} & \textbf{50.7} & \textbf{75.9} & \textbf{28.1} & \textbf{18.9} & \textbf{48.7} & \textbf{45.8} \\
\bottomrule
\end{tabular}
